...
def main(random_seed, is_race_permute, is_sex_permute, is_sex_race_both_permute, 
    ...
    model_save_dir = os_join(res_path, f'adult-v2-model_config-{model_config}-max_epoch={max_epoch}-train_bs={train_bs}-random_seed={random_seed}-is_random_weight-{is_random_weight}-race_permute={is_race_permute}-sex_permute={is_sex_permute}-both_sex_race_permute={is_sex_race_both_permute}')
...
def main_based_on_sym_diff(random_seed, is_race_permute, is_sex_permute, is_sex_race_both_permute, 
    ...
    for _ in range(K):
        ...
        # save model, with dev/test results
        model_save_dir = os_join(res_path, f'adult-v2-model_config-{model_config}-max_epoch={max_epoch}-train_bs={train_bs}-random_seed={random_seed}-is_random_weight-{is_random_weight}-race_permute={is_race_permute}-sex_permute={is_sex_permute}'+
